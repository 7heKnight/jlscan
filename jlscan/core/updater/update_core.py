...
def update_core():
    ...
    end_page = 0
    counter = 0
    success_msg('Crawling on ' + link_msg('https://developer.joomla.org/security-centre.html\n\n'))

    while True:
        wait_msg(f'Crawling on site: https://developer.joomla.org/security-centre.html?start={counter * 10} ')
